...
describe('W3W Contract', async () => {
	...
	beforeEach('Setup Contract', async () => {
		const W3W = await ethers.getContractFactory('W3W')
		nft = await W3W.deploy()
		await nft.deployed()
