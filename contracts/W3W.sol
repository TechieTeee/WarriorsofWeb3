...
contract W3W is ERC721URIStorage {
  ...
  constructor() ERC721("W3W", "W3W") {
    collectionName = name();
    collectionSymbol = symbol();
  }

  function createW3W() public returns(uint256) {
        ...
        bytes(
            string(
                ...
                '{"name": "',
                    ...
                    '", "description": "The Fierce Warriors of Web 3", "image": "data:image/svg+xml;base64,',
